...
export default function PhotoBox({name, title, description, avatar, big = false, className =''}: {
    ...
    return (
        <nav className={`flex flex-col gap-2 justify-center items-center text-foreground ${big ? 'max-[25vw]:m-2 max-[25vw]:p-5 min-[25vw]:w-full min-[30vw]:h-[100vh]' : 'mb-6'} ${className}`}>
